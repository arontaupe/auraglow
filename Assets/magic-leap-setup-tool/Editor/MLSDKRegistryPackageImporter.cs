...
{ 
    /// <summary>
    /// Manages importing the Magic Leap package via the Magic Leap registry
    /// </summary>
    public class MLSDKRegistryPackageImporter : MonoBehaviour
    {
        ...
        public static void AddRegistryAndImportMlSdk(Action<bool> success)
        {
        ...
        {
            MethodInfo ShowPackageManagerMethodInfo = null;
